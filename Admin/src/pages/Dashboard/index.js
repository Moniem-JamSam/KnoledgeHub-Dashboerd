...
import booksIcon1 from "../../assets/images/services-icon/booksIcon1.png";
import BookIcon2 from "../../assets/images/services-icon/BookIcon2.png";
...
// moniem png
import CallCenterPng from "../../assets/images/moniem/Call-Center.png";

import Slidewithcaption from "../../pages/Ui/CarouselTypes/slidewithcaption";
        ...
        <Container fluid>
            ...
            <Row className="align-items-center">
              <Col md={8}>
                ...
                <ol className="breadcrumb m-0">
                  <li className="breadcrumb-item active">Welcome to Knowledge Hub Dashboard</li>
                </ol>
              </Col>
              ...
              <Col md="4">
                <div className="float-end d-none d-md-block">
                  <Dropdown isOpen={menu} toggle={toggle}>
                    ...
                    <DropdownMenu right>
                      <DropdownItem tag="a" href="#">Report a Problem</DropdownItem>
                      <DropdownItem tag="a" href="#">Help Center</DropdownItem>
                      <DropdownItem tag="a" href="#">Support Inboxe</DropdownItem>
                      <DropdownItem divider />
                      <DropdownItem tag="a" href="#">Log Out</DropdownItem>
                    </DropdownMenu>
                  </Dropdown>
                </div>
              </Col>
              ...
              <Card className="mini-stat bg-primary text-white">
                <CardBody>
                  ...
                  <div className="pt-2">
                    ...
                    <p className="text-white-50 mb-0 mt-1">See All</p>
                  </div>
                </CardBody>
              </Card>
            </Col>
          ...
          <Row>
            <Col xl={9}>
              <Card>
                <CardBody>
                  <h4 className="card-title mb-4">Monthly Vistors</h4>
                  <Row>
                    <Col lg={7}>
                      <div>
                        <LineAreaChart />
                    ...
                    <Col lg={5}>
                      <Row>
                        ...
                        <Col md={6}>
                          <div className="text-center">
                            <p className="text-muted mb-4">Last month Vistors</p>
                            <h3>184 Vistor</h3>
                            <p className="text-muted mb-5">
                              Grow More by Click Here 
                            </p>
            ...
            <Col xl={3}>
              <Card>
                <CardBody>
                  <div>
                    <h4 className="card-title mb-4 ">Help Center</h4>
                  </div>
                  ...
                  <div className="wid-peity mb-2">
                    <Row>
                      ...
                      <h3>
                        <br></br>
                        <br></br>
                        Hi, we can help you by Clicking Here</h3>
                      </div>
                      <div>
                        <br></br>
                      <Button
                      ...
                      <img src={CallCenterPng} alt="" height={230} />
                    </div>
                      </Col>
                    </Row>
